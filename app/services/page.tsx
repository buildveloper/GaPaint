import { services, photos } from '../../components/siteData';
      ...
      <div className='mt-8 grid md:grid-cols-2 gap-4'>
        {services.map((s, idx) => (
          <article className='glass p-6' key={s}>
            <img
              src={photos.services[idx % photos.services.length]}
              alt={`${s} service example`}
            ...
            <a href='/contact' className='mt-3 inline-block text-amber-500'>Request Estimate →</a>
          </article>
        ))}
      </div>
    </main>
